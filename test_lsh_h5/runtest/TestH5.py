...
class TestApp(unittest.TestCase):
    ...
    def testLogin(self):
        ...
        loginTest = LoginTest(self.enverionment,self.host,self.h5Confpath,self.testCasePath,testCaseDoc,self.testResultsPath)#登录测试
        loginTest.loginTest()
    ...
    def testHomePage(self):
        ...
        homepageTest=HomePageTest(self.enverionment,self.host,self.h5Confpath,self.testCasePath,testCaseDoc,self.testResultsPath)
    ...
    def testMyPage(self):
        ...
        mypageTest=MyPageTest(self.enverionment,self.host,self.h5Confpath,self.testCasePath,testCaseDoc,self.testResultsPath)
    ...
    def testShoppingCartPage(self):
        ...
        shoppingCartpageTest=ShoppingCartPageTest(self.enverionment,self.host,self.h5Confpath,self.testCasePath,testCaseDoc,self.testResultsPath)
    ...
    def testClassifyPage(self):
        ...
        classifyPageTest=ClassifyPageTest(self.enverionment,self.host,self.h5Confpath,self.testCasePath,testCaseDoc,self.testResultsPath)
